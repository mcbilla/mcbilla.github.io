...
### 1、安装评论系统
理论上 Hexo 支持 **DISQUS、Facebook Comments、HyperComments、网易云跟帖**和**来必力**等评论插件，但是由于国内被墙或者服务商不再提供服务等原因，选择**来必力**作为我们的评论系统。
...
#### 1）安装 [hexo-generator-searchdb](https://www.npmjs.com/package/hexo-generator-searchdb)
在安装目录下执行
```
$ npm install hexo-generator-searchdb --save
```

#### 2）编辑 <font color=#5CACEE size=3>站点配置文件</font>
新增以下内容到任意位置：
```
search:
  path: search.xml
...
#### 3）编辑 <font color=#BF3EFF size=3>主题配置文件</font>
查找 `local_search` 字段，把值改为 `true`
```
# Local search
local_search:
  enable: true
