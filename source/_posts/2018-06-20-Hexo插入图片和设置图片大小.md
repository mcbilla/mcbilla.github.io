...
上述是从文章资源文件夹中引用图片，前提是**先将图片放入到文章资源文件夹**，如果图片数量众多的话，一张一张的放很影响效率。Typora对于插入图片的支持做得非常好，设置 **偏好设置—编辑器——图片插入**，设置**复制到指定路径**，值为 `./${filename}`，然后勾选下面的按钮。

![image-20230228210053645](image-20230228210053645.png)
